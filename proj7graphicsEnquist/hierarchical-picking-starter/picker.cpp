...
bool Picker::visit(SgShapeNode& node) {
  idCounter_++;
  shared_ptr<SgNode> Parent = nodeStack_.back();
  shared_ptr<SgRbtNode> rigidNode = dynamic_pointer_cast<SgRbtNode>(Parent);
  addToMap(idCounter_,rigidNode);
