...
static void constructRobot(shared_ptr<SgTransformNode> base, const Cvec3& color) {
  ...
  ShapeDesc shapeDesc[NUM_SHAPES] = {
    ...
    {1, ARM_LEN/2, 0, 0, ARM_LEN, ARM_THICK, ARM_THICK, g_cube}, // right arm
    {2, ARM_LEN/2, 0, 0, ARM_LEN, ARM_THICK, ARM_THICK, g_cube}, // right right arm
    {3, ARM_LEN/2, 0, 0, ARM_LEN, ARM_THICK, ARM_THICK, g_cube}, // righter right arm
